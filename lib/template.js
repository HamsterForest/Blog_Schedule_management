module.exports={
    homepage:function(bloglist,schlist,stylesheet){
        return `
            ...
            <body>
                ...
                <a class="mainlink" href="/createblog">Create Blog Post</a>
                <a class="mainlink" href="/createsch">Create Schedule</a>
                <main>
    ...
    subpage:function(bloglist,schlist,title,description,stylesheet){
        return `
            ...
            <body>
                ...
                <a class="mainlink" href="/create">Create Blog Post</a>
                <a class="mainlink" href="/createsch">Create Schedule</a>
                <main>
                    <h2>${title}</h2>
                    <p>
    ...
    createpage:function(bloglist,schlist,stylesheet,control){
        return `
            <!DOCTYPE html>
            <html>
            <head>
            ...
            <body>
                ...
                <main>
                    ...
                    <p>
                        <form action="/create_${control}process" method="post">
